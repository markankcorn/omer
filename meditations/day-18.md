...
day_sefirah = "Netzach"
title = "Endurance within Compassion"
title_hebrew = "נֶצַח שֶׁבְּתִּפְאֶרֶת"
+++

What can we do to ensure that our compassion is enduring? This is a different aspect than gevurah / discipline that we learned about two days ago, and is often associated with confidence by the Hasidic masters.
